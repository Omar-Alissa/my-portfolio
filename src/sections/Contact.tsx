              ...
              <div className="space-y-6">
                <div className="flex items-center gap-6 p-4 bg-[#21363b] rounded-lg hover:scale-105 transition-all">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a href="mailto:omarissa179@gmail.com" className="text-base md:text-lg hover:text-[#a3a380] transition-colors font-medium">
                ...
                <div className="flex items-center gap-6 p-4 bg-[#21363b] rounded-lg hover:scale-105 transition-all">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a href="tel:+46765856550" className="text-base md:text-lg hover:text-[#a3a380] transition-colors font-medium">
                      +46 765856550
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6 p-4 bg-[#21363b] rounded-lg hover:scale-105 transition-all">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a href="https://github.com/Omar-Alissa" target="_blank" rel="noopener noreferrer" className="text-base md:text-lg hover:text-[#a3a380] transition-colors font-medium">
